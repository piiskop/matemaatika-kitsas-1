...
description: "kitsa matemaatika esimese kursuse õpe"
lang: et
include-before:
    - \input{title-page.tex}
title: "`r if (knitr::is_latex_output()) { '' } else { 'kitsa matemaatika<br/>esimese kursuse<br/> õpe' }`"
...
Kui õpilasel on ahhaa-efekt, siis õpetajal võib olla juhhuu-efekt või ohhoo-efekt.
